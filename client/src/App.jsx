...
export default function App() {
  ...
  /* =========================================================
     OLD LOCAL TENANTS
     Kept only for compatibility / fallback
  ========================================================= */
  ...
  const [backendTenant, setBackendTenant] =
    useState(null);
  ...
  /* =========================================================
     ...
     TenantLogin sends:
       ...
       onLogin(result.user, result.tenant)
     
     So this function MUST receive:
  ...
  function handleAuthSuccess(
    ...
    if (!tenant) {
      ...
      console.error(
        "Authentication succeeded but tenant is missing."
      );
    ...
    /* -------------------------------------------------------
       ...
       Backend subscription irundha
       atha use pannum.
       
       Illana temporary frontend trial create pannum.
    ------------------------------------------------------- */
  ...
  /* =========================================================
     CREATE TENANT - OLD LOCAL FALLBACK
     
     Not used by current TenantLogin.
        ...
        <CenteredAuthShell>
          ...
          <TenantLogin
            ...
            /*
              ...
              Therefore we use handleAuthSuccess.
            */
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Ready to manage your herd today?
                      </p>
